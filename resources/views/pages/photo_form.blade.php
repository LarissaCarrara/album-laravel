                ...
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <div
                      ...
                      <img id="imgPrev" height="340" class="w-100" style="object-fit: cover;" src="{{isset($photo) ? url("/storage/photos/$photo->photo_url") : asset('/img/img_padrao.png')}}" alt="">
                    </div>
                    <div class="form-group mt-2">
                      <div class="custom-file">
                        <input id="customFile" name="photo" type="file" accept="image/png, image/jpeg, image/gif" class="custom-file-input" onchange="loadFile(event)" @empty($photo) required @endempty>
                      </div>
                    </div>
                  </div>
